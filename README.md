...
- portrait：当前侧栏头像和论文缩略图均为空白图位。如果希望使用个人照片或论文插图，将经过授权的图片放入 `assets/`，提供明确替代文本后再替换对应图位。
...
当前整体信息架构参考了 MIT 许可的 [luost26/academic-homepage](https://github.com/luost26/academic-homepage)：桌面端采用固定身份侧栏与右侧学术信息流，移动端改为单列。实现代码与视觉变量均在本项目中重新编写。
